...
public class TestFinalWorkDuration extends TestBase {
    ...
    public void testFinalDuration(Map<String, String> testData) throws InterruptedException {
        ...
        boolean check = displayFlags.isShowFinalDuration();
        ...
        if ( isDisplayed && ( check != isDisplayed) ) {
            ...
            if ( finalDur == attPage)
                ...
                Reporter("Final Work Duration is not as expected "+userEnd,"FAIL");
                Reporter("Expected is "+finalDur+" Actual is "+attPage,"INFO");
            }
        }
    }
}
