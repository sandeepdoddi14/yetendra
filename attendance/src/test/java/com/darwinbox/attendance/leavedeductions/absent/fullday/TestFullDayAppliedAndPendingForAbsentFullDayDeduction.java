...
public class TestFullDayAppliedAndPendingForAbsentFullDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndPendingForAbsentFullDayDeduction(Map<String, String> testData) {
