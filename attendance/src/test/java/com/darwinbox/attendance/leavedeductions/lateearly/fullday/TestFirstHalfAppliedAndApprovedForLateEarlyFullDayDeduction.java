...
public class TestFirstHalfAppliedAndApprovedForLateEarlyFullDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndApprovedForLateEarlyFullDayDeduction(Map<String, String> testData) {
