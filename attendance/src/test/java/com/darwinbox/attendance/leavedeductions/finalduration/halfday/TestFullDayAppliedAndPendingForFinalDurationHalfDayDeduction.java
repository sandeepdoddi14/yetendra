...
public class TestFullDayAppliedAndPendingForFinalDurationHalfDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndPendingForFinalDurationHalfDayDeduction(Map<String, String> testData) {
