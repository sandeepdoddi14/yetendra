...
public class TestLateDurationAndLateMarkDeduction extends TestBase {
    ...
    @Test(dataProvider = "TestRuns", dataProviderClass = TestDataProvider.class, groups = "LateDuration,EarlyMark,LeaveDeduction", retryAnalyzer = TestBase.class)
