...
public class TestFirstHalfAppliedAndApprovedForFinalDurationFullDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndApprovedForFinalDurationFullDayDeduction(Map<String, String> testData) {
