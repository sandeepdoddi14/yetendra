...
public class TestFullDayAppliedAndPendingForLateEarlyFullDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndPendingForLateEarlyFullDayDeduction(Map<String, String> testData) {
