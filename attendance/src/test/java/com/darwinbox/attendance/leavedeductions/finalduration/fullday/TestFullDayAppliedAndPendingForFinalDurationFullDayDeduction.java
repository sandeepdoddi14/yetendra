package com.darwinbox.attendance.leavedeductions.finalduration.fullday;
...
public class TestFullDayAppliedAndPendingForFinalDurationFullDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndPendingForFinalDurationFullDayDeduction(Map<String, String> testData) {

        String title = " With Full day Applied and Pending ";
