...
public class TestFullDayAppliedAndPendingForEarlyByFullDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndPendingForEarlyDurationFullDayDeduction(Map<String, String> testData) {
