...
public class TestFirstHalfAppliedAndApprovedForLateMarkFullDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndApprovedForLateMarkFullDayDeduction(Map<String, String> testData) {
        ...
        String isPayCycle = testData.get("isPayCycle");

        AttendanceSettingsPage attSettings = new AttendanceSettingsPage();
        attSettings.setUsePayrollCycle(isPayCycle.equalsIgnoreCase("yes"));
        ...
        for (LeaveDeductionsBase.DAYSTATUS day : LeaveDeductionsBase.DAYSTATUS.values()) {
            ...
            List<Date> dates = dateHelper.getDatesForNextNDays(date, lateMark.getCount() * 2);
