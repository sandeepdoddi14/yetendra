...
public class TestFullDayAppliedAndApprovedForTotalDurationHalfDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndApprovedForTotalDurationHalfDayDeduction(Map<String, String> testData) {
