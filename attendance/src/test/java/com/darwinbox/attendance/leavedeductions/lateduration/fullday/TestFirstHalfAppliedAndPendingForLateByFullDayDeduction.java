...
public class TestFirstHalfAppliedAndPendingForLateByFullDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndPendingForLateDurationFullDayDeduction(Map<String, String> testData) {
