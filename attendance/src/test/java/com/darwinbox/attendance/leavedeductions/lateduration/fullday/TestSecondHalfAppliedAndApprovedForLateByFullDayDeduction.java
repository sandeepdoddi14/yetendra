package com.darwinbox.attendance.leavedeductions.lateduration.fullday;
...
public class TestSecondHalfAppliedAndApprovedForLateByFullDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndApprovedForLateDurationFullDayDeduction(Map<String, String> testData) {
