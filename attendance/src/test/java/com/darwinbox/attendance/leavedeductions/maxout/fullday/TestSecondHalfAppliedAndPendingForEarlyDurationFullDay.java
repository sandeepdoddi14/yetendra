...
public class TestSecondHalfAppliedAndPendingForEarlyDurationFullDay extends TestBase {
    ...
    public void testSecondHalfAppliedAndPending(Map<String, String> testData) {
        ...
        EarlyDuration absent = policy.getEarlyDuration();
        ...
        for (LeaveDeductionsBase.DAYSTATUS day : LeaveDeductionsBase.DAYSTATUS.values()) {
            ...
            Map<String, String> body = absent.getEarlyDuration(employee.getEmployeeID(), policy.getPolicyInfo().getPolicyName(), shift, date,false, isWeekoff);
