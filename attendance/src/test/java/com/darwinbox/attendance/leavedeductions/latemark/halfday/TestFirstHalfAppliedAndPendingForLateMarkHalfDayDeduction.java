...
public class TestFirstHalfAppliedAndPendingForLateMarkHalfDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndPendingForLateDurationHalfDayDeduction(Map<String, String> testData) {
