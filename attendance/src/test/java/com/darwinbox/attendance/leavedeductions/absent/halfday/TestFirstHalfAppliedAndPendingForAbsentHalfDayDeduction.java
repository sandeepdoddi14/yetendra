...
public class TestFirstHalfAppliedAndPendingForAbsentHalfDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndPendingForAbsentHalfDayDeduction(Map<String, String> testData) {
