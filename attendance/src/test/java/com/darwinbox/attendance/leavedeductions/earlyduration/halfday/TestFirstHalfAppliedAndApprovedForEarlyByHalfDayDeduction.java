package com.darwinbox.attendance.leavedeductions.earlyduration.halfday;
...
public class TestFirstHalfAppliedAndApprovedForEarlyByHalfDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndApprovedForEarlyDurationHalfDayDeduction(Map<String, String> testData) {
