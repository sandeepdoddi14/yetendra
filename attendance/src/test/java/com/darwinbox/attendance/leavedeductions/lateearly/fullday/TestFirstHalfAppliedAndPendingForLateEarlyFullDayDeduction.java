...
public class TestFirstHalfAppliedAndPendingForLateEarlyFullDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndPendingForLateEarlyFullDayDeduction(Map<String, String> testData) {
