...
public class TestFullDayAppliedAndPendingForTotalDurationFullDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndPendingForTotalDurationFullDayDeduction(Map<String, String> testData) {
