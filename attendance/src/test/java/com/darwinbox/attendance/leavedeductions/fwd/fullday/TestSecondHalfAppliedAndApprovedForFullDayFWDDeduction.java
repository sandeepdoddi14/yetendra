package com.darwinbox.attendance.leavedeductions.fwd.fullday;
...
public class TestSecondHalfAppliedAndApprovedForFullDayFWDDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndApproved(Map<String, String> testData) {
        ...
        for (LeaveDeductionsBase.DAYSTATUS day : LeaveDeductionsBase.DAYSTATUS.values()) {
            ...
            try {
                ...
                boolean proceed = workDuration.isInDay() && ((isholiday && workDuration.isHoliday()) ||
