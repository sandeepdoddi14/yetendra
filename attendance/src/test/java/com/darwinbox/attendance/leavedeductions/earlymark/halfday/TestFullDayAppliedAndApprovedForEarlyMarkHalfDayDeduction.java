...
public class TestFullDayAppliedAndApprovedForEarlyMarkHalfDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndApprovedForEarlyMarkHalfDayDeduction(Map<String, String> testData) {
