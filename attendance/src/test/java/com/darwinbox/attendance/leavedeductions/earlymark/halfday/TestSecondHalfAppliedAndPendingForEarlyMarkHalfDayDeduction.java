...
public class TestSecondHalfAppliedAndPendingForEarlyMarkHalfDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndPendingForEarlyMarkHalfDayDeduction(Map<String, String> testData) {
