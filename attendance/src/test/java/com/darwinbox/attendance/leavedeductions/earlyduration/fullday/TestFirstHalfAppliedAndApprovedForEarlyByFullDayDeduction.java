...
public class TestFirstHalfAppliedAndApprovedForEarlyByFullDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndApprovedForEarlyDurationFullDayDeduction(Map<String, String> testData) {
