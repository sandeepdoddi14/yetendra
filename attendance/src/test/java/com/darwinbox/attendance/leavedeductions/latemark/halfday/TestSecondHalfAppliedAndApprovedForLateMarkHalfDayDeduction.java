package com.darwinbox.attendance.leavedeductions.latemark.halfday;
...
public class TestSecondHalfAppliedAndApprovedForLateMarkHalfDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndApprovedForLateDurationHalfDayDeduction(Map<String, String> testData) {
