...
public class TestSecondHalfAppliedAndPendingForLateByFullDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndPendingForLateDurationFullDayDeduction(Map<String, String> testData) {
