...
public class TestFirstHalfAppliedAndApprovedForLateMarkHalfDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndApprovedForLateDurationHalfDayDeduction(Map<String, String> testData) {
