...
public class TestFullDayAppliedAndPendingForLateMarkHalfDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndPendingForLateDurationHalfDayDeduction(Map<String, String> testData) {
