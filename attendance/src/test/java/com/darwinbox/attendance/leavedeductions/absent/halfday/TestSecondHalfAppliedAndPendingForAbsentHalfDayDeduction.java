...
public class TestSecondHalfAppliedAndPendingForAbsentHalfDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndPendingForAbsentHalfDayDeduction(Map<String, String> testData) {
