...
public class TestFirstHalfAppliedAndPendingForFinalDurationFullDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndPendingForFinalDurationFullDayDeduction(Map<String, String> testData) {
