...
public class TestSecondHalfAppliedAndPendingForEarlyByHalfDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndPendingForLateDurationHalfDayDeduction(Map<String, String> testData) {
        ...
        for (LeaveDeductionsBase.DAYSTATUS day : LeaveDeductionsBase.DAYSTATUS.values()) {
            ...
            if (proceed) {
                atb.validateLeave(!lateDuration.isApprovalRequired(), isFirst || isSecond, status, leaveName, this);
            } else {
