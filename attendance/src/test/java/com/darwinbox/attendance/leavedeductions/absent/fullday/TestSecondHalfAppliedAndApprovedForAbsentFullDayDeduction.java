...
public class TestSecondHalfAppliedAndApprovedForAbsentFullDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndApprovedForAbsentFullDayDeduction(Map<String, String> testData) {
