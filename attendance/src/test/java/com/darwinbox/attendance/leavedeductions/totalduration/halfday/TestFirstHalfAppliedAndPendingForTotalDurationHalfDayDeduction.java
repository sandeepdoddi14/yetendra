...
public class TestFirstHalfAppliedAndPendingForTotalDurationHalfDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndPendingForTotalDurationHalfDayDeduction(Map<String, String> testData) {
