...
public class TestFullDayAppliedAndPendingForLateByFullDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndPendingForLateDurationFullDayDeduction(Map<String, String> testData) {
