package com.darwinbox.attendance.leavedeductions.maxout.fullday;
...
public class TestFirstHalfAppliedAndPendingForEarlyDurationFullDay extends TestBase {
    ...
    public void testFirstHalfAppliedAndPending(Map<String, String> testData) {
        ...
        if (earlyDuration == null) {
            ...
            Assert.assertFalse(true, "Leave deductions for Early Duration  is not enabled");
        }
        ...
        for (LeaveDeductionsBase.DAYSTATUS day : LeaveDeductionsBase.DAYSTATUS.values()) {
            ...
            Map<String, String> body = earlyDuration.getEarlyDuration(employee.getEmployeeID(), policy.getPolicyInfo().getPolicyName(), shift,date, false, isWeekoff);
            ...
            if (proceed) {
                atb.validateLeave(!earlyDuration.isApprovalRequired(), isFirst || isSecond, status, leaveName, this);
            } else {
