...
public class TestFullDayAppliedAndApprovedForLateMarkHalfDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndApprovedForLateDurationHalfDayDeduction(Map<String, String> testData) {
