...
public class TestSecondHalfAppliedAndPendingForEarlyByFullDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndPendingForEarlyDurationFullDayDeduction(Map<String, String> testData) {
