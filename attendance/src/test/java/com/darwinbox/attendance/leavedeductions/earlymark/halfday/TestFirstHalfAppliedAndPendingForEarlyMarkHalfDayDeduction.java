...
public class TestFirstHalfAppliedAndPendingForEarlyMarkHalfDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndPendingForEarlyMarkHalfDayDeduction(Map<String, String> testData) {
