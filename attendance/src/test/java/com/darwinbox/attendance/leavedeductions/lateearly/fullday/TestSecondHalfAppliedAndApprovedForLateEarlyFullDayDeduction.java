...
public class TestSecondHalfAppliedAndApprovedForLateEarlyFullDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndApprovedForLateEarlyFullDayDeduction(Map<String, String> testData) {
