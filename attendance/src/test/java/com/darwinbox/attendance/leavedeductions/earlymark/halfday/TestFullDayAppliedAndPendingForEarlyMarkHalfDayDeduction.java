...
public class TestFullDayAppliedAndPendingForEarlyMarkHalfDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndPendingForEarlyMarkFullDayDeduction(Map<String, String> testData) {
