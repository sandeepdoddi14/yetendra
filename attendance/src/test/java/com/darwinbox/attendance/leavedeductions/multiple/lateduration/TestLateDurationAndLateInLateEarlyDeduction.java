...
public class TestLateDurationAndLateInLateEarlyDeduction extends TestBase {
    ...
    public void testForLateDurationAndLateinLateEarly(Map<String, String> testData) {

        String title = " With Late Duration and Late Mark in LateEarly";
