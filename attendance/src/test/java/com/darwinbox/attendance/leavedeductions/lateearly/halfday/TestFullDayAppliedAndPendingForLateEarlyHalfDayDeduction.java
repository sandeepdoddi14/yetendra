...
public class TestFullDayAppliedAndPendingForLateEarlyHalfDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndPendingForLateEarlyHalfDayDeduction(Map<String, String> testData) {

        String title = " With Leave Applied and Pending ";
