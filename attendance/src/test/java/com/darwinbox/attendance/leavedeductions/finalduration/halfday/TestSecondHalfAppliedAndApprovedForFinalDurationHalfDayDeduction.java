...
public class TestSecondHalfAppliedAndApprovedForFinalDurationHalfDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndApprovedForFinalDurationHalfDayDeduction(Map<String, String> testData) {
