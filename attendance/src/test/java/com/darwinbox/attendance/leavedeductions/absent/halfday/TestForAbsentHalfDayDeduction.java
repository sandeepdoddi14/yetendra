...
public class TestForAbsentHalfDayDeduction extends TestBase {
    ...
    public void testForAbsentHalfDayDeduction(Map<String, String> testData) {
        ...
        for (LeaveDeductionsBase.DAYSTATUS day : LeaveDeductionsBase.DAYSTATUS.values()) {
            ...
            if (proceed) {
                atb.validateLeave(!absent.isApprovalRequired(), true, status, leaveName, this);
            } else {
