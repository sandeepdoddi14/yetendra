...
public class TestFirstHalfAppliedAndPendingForEarlyByFullDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndPendingForEarlyDurationFullDayDeduction(Map<String, String> testData) {
