...
public class TestFullDayAppliedAndApprovedForFinalDurationHalfDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndApprovedForFinalDurationHalfDayDeduction(Map<String, String> testData) {
