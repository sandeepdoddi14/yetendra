...
public class TestSecondHalfAppliedAndApprovedForEarlyByHalfDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndApprovedForEarlyDurationHalfDayDeduction(Map<String, String> testData) {
