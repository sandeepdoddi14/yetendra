...
public class TestSecondHalfAppliedAndApprovedForFinalDurationFullDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndApprovedForFinalDurationFullDayDeduction(Map<String, String> testData) {
