...
public class TestSecondHalfAppliedAndPendingForAbsentFullDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndPendingForAbsentFullDayDeduction(Map<String, String> testData) {
