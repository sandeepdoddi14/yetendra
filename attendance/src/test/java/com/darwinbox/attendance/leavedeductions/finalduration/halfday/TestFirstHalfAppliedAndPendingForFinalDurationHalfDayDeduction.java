...
public class TestFirstHalfAppliedAndPendingForFinalDurationHalfDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndPendingForFinalDurationHalfDayDeduction(Map<String, String> testData) {
