...
public class TestFirstHalfAppliedAndPendingForAbsentFullDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndPendingForAbsentFullDayDeduction(Map<String, String> testData) {
