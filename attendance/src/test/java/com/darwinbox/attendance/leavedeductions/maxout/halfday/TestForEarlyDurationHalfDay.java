...
public class TestForEarlyDurationHalfDay extends TestBase {
    ...
    public void testForHalfDayDeduction(Map<String, String> testData) {
        ...
        for (LeaveDeductionsBase.DAYSTATUS day : LeaveDeductionsBase.DAYSTATUS.values()) {
            ...
            Map<String, String> body = absent.getEarlyDuration(employee.getEmployeeID(), policy.getPolicyInfo().getPolicyName(), shift, date,true, isWeekoff);
