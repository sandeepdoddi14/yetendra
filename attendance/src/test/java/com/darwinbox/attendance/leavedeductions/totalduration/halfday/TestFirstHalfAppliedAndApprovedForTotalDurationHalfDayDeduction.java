package com.darwinbox.attendance.leavedeductions.totalduration.halfday;
...
public class TestFirstHalfAppliedAndApprovedForTotalDurationHalfDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndApprovedForTotalDurationHalfDayDeduction(Map<String, String> testData) {
