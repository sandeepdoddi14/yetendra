...
public class TestFirstHalfAppliedAndPendingForLateEarlyHalfDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndPendingForLateEarlyHalfDayDeduction(Map<String, String> testData) {
