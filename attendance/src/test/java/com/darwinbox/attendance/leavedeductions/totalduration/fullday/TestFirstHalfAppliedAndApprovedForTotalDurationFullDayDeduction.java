...
public class TestFirstHalfAppliedAndApprovedForTotalDurationFullDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndApprovedForTotalDurationFullDayDeduction(Map<String, String> testData) {
