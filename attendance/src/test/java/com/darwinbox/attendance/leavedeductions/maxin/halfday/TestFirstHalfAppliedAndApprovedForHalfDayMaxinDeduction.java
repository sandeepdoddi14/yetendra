...
public class TestFirstHalfAppliedAndApprovedForHalfDayMaxinDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndApproved(Map<String, String> testData) {
        ...
        for (LeaveDeductionsBase.DAYSTATUS day : LeaveDeductionsBase.DAYSTATUS.values()) {
            ...
            try {
                ...
                Assert.assertFalse(status.contains("(" + leaveName + ")"), "No Leave is Deducted and in Pending state");
