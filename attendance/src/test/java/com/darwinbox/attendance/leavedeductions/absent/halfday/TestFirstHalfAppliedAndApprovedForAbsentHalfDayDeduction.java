...
public class TestFirstHalfAppliedAndApprovedForAbsentHalfDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndApprovedForAbsentHalfDayDeduction(Map<String, String> testData) {
