...
public class TestSecondHalfAppliedAndApprovedForTotalDurationHalfDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndApprovedForTotalDurationHalfDayDeduction(Map<String, String> testData) {
