...
public class TestFullDayAppliedAndPendingForLateMarkFullDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndPendingForLateMarkFullDayDeduction(Map<String, String> testData) {
