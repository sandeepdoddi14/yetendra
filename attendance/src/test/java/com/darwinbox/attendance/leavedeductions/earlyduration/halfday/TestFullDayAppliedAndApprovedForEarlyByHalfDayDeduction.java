...
public class TestFullDayAppliedAndApprovedForEarlyByHalfDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndApprovedForEarlyDurationHalfDayDeduction(Map<String, String> testData) {
