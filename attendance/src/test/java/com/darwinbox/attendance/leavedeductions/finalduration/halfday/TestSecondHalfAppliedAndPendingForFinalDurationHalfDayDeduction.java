...
public class TestSecondHalfAppliedAndPendingForFinalDurationHalfDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndPendingForTotalDurationHalfDayDeduction(Map<String, String> testData) {
