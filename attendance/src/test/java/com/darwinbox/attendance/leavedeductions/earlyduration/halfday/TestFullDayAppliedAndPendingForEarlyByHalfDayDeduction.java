...
public class TestFullDayAppliedAndPendingForEarlyByHalfDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndPendingForEarlyDurationHalfDayDeduction(Map<String, String> testData) {
