...
public class TestFullDayAppliedAndApprovedForEarlyByFullDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndApprovedForEarlyDurationFullDayDeduction(Map<String, String> testData) {
