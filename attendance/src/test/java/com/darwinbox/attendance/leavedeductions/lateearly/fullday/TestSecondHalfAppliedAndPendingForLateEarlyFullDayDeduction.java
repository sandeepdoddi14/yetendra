...
public class TestSecondHalfAppliedAndPendingForLateEarlyFullDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndPendingForLateEarlyFullDayDeduction(Map<String, String> testData) {
