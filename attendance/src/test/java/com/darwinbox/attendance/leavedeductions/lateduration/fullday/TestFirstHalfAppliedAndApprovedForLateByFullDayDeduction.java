...
public class TestFirstHalfAppliedAndApprovedForLateByFullDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndApprovedForLateDurationFullDayDeduction(Map<String, String> testData) {
