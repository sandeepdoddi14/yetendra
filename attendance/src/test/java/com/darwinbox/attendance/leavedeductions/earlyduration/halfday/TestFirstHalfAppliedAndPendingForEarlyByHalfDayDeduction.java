...
public class TestFirstHalfAppliedAndPendingForEarlyByHalfDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndPendingForEarlyDurationHalfDayDeduction(Map<String, String> testData) {
