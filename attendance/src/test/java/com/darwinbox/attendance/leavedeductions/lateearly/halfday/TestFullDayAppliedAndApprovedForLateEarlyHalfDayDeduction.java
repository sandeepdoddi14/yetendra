...
public class TestFullDayAppliedAndApprovedForLateEarlyHalfDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndApprovedForLateEarlyHalfDayDeduction(Map<String, String> testData) {

        String title = " With Leave Applied and Approved ";
