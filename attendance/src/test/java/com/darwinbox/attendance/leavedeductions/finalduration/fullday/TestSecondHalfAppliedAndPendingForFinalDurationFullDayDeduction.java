...
public class TestSecondHalfAppliedAndPendingForFinalDurationFullDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndPendingForFinalDurationFullDayDeduction(Map<String, String> testData) {
