package com.darwinbox.attendance.leavedeductions.absent.halfday;
...
public class TestFullDayAppliedAndPendingForAbsentHalfDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndPendingForAbsentHalfDayDeduction(Map<String, String> testData) {
