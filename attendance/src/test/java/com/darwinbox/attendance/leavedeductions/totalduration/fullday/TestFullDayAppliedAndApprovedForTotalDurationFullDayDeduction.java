...
public class TestFullDayAppliedAndApprovedForTotalDurationFullDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndApprovedForTotalDurationFullDayDeduction(Map<String, String> testData) {
