...
public class TestFullDayAppliedAndPendingForTotalDurationHalfDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndPendingForTotalDurationHalfDayDeduction(Map<String, String> testData) {
