...
public class TestSecondHalfAppliedAndPendingForLateEarlyHalfDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndPendingForLateEarlyHalfDayDeduction(Map<String, String> testData) {
