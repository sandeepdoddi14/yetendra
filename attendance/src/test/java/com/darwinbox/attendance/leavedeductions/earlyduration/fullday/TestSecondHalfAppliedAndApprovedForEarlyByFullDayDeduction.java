...
public class TestSecondHalfAppliedAndApprovedForEarlyByFullDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndApprovedForEarlyDurationFullDayDeduction(Map<String, String> testData) {
