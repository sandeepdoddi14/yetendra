...
public class TestForLateEarlyHalfDayDeduction extends TestBase {
    ...
    public void testForLateEarlyHalfDayDeduction(Map<String, String> testData) {
        ...
        for (LeaveDeductionsBase.DAYSTATUS day : LeaveDeductionsBase.DAYSTATUS.values()) {
            ...
            for ( Date d : dates ) {
                ...
                if (proceed) {
                    atb.validateLeave(!latePlusEarly.isApprovalRequired(), true, status, leaveName, this);
                } else {
