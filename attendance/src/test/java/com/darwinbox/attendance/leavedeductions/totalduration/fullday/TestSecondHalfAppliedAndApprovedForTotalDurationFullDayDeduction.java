...
public class TestSecondHalfAppliedAndApprovedForTotalDurationFullDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndApprovedForTotalDurationFullDayDeduction(Map<String, String> testData) {
