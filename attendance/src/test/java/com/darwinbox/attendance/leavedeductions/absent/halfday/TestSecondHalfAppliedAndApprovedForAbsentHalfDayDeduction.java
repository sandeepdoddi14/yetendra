...
public class TestSecondHalfAppliedAndApprovedForAbsentHalfDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndApprovedForAbsentHalfDayDeduction(Map<String, String> testData) {
