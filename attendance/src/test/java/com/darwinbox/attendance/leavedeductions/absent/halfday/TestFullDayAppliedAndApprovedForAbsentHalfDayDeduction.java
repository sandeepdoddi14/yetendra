...
public class TestFullDayAppliedAndApprovedForAbsentHalfDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndApprovedForAbsentHalfDayDeduction(Map<String, String> testData) {
