...
public class TestFullDayAppliedAndApprovedForLateEarlyFullDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndApprovedForLateEarlyFullDayDeduction(Map<String, String> testData) {
