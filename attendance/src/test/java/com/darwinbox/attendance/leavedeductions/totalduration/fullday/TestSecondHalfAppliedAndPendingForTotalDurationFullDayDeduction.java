...
public class TestSecondHalfAppliedAndPendingForTotalDurationFullDayDeduction extends TestBase {
    ...
    public void testSecondHalfAppliedAndPendingForTotalDurationFullDayDeduction(Map<String, String> testData) {
