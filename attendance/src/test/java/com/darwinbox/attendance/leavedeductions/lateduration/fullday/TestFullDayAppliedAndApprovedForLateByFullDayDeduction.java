...
public class TestFullDayAppliedAndApprovedForLateByFullDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndApprovedForLateDurationFullDayDeduction(Map<String, String> testData) {
