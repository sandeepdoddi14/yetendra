...
public class TestFullDayAppliedAndApprovedForFinalDurationFullDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndApprovedForFinalDurationFullDayDeduction(Map<String, String> testData) {
