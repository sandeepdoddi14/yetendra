...
public class TestFullDayAppliedAndApprovedForAbsentFullDayDeduction extends TestBase {
    ...
    public void testFullDayAppliedAndApprovedForAbsentFullDayDeduction(Map<String, String> testData) {
