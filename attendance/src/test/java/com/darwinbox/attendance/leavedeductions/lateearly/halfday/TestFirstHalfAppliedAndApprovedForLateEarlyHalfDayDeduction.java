...
public class TestFirstHalfAppliedAndApprovedForLateEarlyHalfDayDeduction extends TestBase {
    ...
    public void testFirstHalfAppliedAndApprovedForLateEarlyHalfDayDeduction(Map<String, String> testData) {
