...
public class TestEarlyOutDatewise extends TestBase {
    ...
    public void testEarlyOutDatewise(Map<String, String> testData) throws Exception {
        ...
        reports.setReportType("opt_roster_14");
        ...
        reportsDashboardServices.getReportEarlyOutDateWise(reports);
    }
