...
public class TestSinglePunchAbsentLeaveWeekoffHoliday extends TestBase {
    LoginPage loginPage;
    ...
    public void testDateWiseAttendanceStatus(Map<String, String> testData) throws Exception {
        ...
        for (AttendanceSettingsPage.DAYS day : AttendanceSettingsPage.DAYS.values()) {
            ...
            if(isLeaves) {
                singlePunchAbsent=0;
                unpaidLeaveCounter=0;
                Reporter("Total Single Punches recorded are-" + singlePunchAbsent, "INFO");
                Reporter("Total Weekoffs recorded are-" + weekOffCounter, "INFO");
                Reporter("Total Holidays recorded are-" + holidayCounter, "INFO");
                Reporter("Total Leaves recorded are-" + leaveCounter, "INFO");
                Reporter("Total Unpaid Leaves recorded are-" + unpaidLeaveCounter, "INFO");
            }
