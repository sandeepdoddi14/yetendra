...
public class OverUtilization extends LeaveBase {
   // static List<LeavePolicyObject> overUtilizationPolicies = null;
    ...
    public void verifyOverUtilization(Map<String, String> data) {
        ...
        Integer fromDate = Integer.parseInt(data.get("from_Date"));
       ...
       // double diff = ChronoUnit.DAYS.between(today.plusDays(fromDate), toDate);
       ...
       noOfLeaves=Double.parseDouble(data.get("noOfLeaves"));
        ...
        if (!halfDay) {
            leavesPage.setFromAndToDatesWithoutProperty(noOfLeaves.intValue(),leaveStartDate);
      ...
      //  }
        ...
        try {
            verifyFixedOverUtilization(leavePolicyObjectObjects.get(0), employeeBalance, noOfLeaves);
        } catch (Exception e) {
            if (applyLeaveResponse.contains(e.toString().replace("java.lang.Exception:", "").trim())) {
                errrorFlag = true;
                actualErrorCount++;
        ...
        try {
            verifyLeavesForConsecutiveLeaveAllowedField(leavePolicyObjectObjects.get(0), noOfLeaves);
        } catch (Exception e) {
            if (applyLeaveResponse.contains(e.toString().replace("java.lang.Exception:", "").trim())) {
                errrorFlag = true;
                actualErrorCount++;
        ...
        try {
            verifyMinimumConsecutiveDaysAllowedInSingleApplication(leavePolicyObjectObjects.get(0), noOfLeaves);
        } catch (Exception e) {
            if (applyLeaveResponse.contains(e.toString().replace("java.lang.Exception:", "").trim())) {
                errrorFlag = true;
                actualErrorCount++;
        ...
        try {
            verifyLeavesForMaxConsecutiveAllowedPerSingleApplicationField(leavePolicyObjectObjects.get(0), noOfLeaves);
        } catch (Exception e) {
        ...
        try {
            verifyLeavesForDontAllowMoreThanYearlyAccural(leavePolicyObjectObjects.get(0), employee, noOfLeaves);
        } catch (Exception e) {
            if (applyLeaveResponse.contains(e.toString().replace("java.lang.Exception:", "").trim())) {
                errrorFlag = true;
                actualErrorCount++;
        ...
        try {
            verifyLeavesForDontAllowMoreThanYearlyAllocation(leavePolicyObjectObjects.get(0), noOfLeaves);
        } catch (Exception e) {
            if (applyLeaveResponse.contains(e.toString().replace("java.lang.Exception:", "").trim())) {
                errrorFlag = true;
                actualErrorCount++;
        ...
        try {
            verifyLeavesForFixedOverUtilization(leavePolicyObjectObjects.get(0), employeeBalance, noOfLeaves);
        } catch (Exception e) {
            if (applyLeaveResponse.contains(e.toString().replace("java.lang.Exception:", "").trim())) {
                errrorFlag = true;
                actualErrorCount++;
