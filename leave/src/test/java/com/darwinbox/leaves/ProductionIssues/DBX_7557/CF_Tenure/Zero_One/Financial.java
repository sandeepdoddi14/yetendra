package com.darwinbox.leaves.ProductionIssues.DBX_7557.CF_Tenure.Zero_One;
...
public class Financial extends LeaveAccuralBase {
    ...
    public void verifyCFWithTenure(Map<String, String> testData) {
        ...
        //1-1 combination
        carryForwardBalance=getTenureWithCarryForward(setAllCarryForwardToMap(testData));
        super.setLeavePolicyObject(carryForwardBalance);
