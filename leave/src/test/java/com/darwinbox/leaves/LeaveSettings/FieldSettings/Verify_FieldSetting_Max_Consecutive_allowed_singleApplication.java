...
public class Verify_FieldSetting_Max_Consecutive_allowed_singleApplication extends TestBase {

    private static final Logger log = Logger.getLogger(Verify_FieldSetting_Max_Consecutive_allowed_singleApplication.class);
    ...
    public void Verify_Min_Consecutive_allowed_Single_Application(Map<String, String> data) throws Exception {
        ...
        Assert.assertTrue( leavePage.setFromAndToDates(Integer.parseInt(data.get("MaxConsecutiveDays"))),"Unable to set Leave Dates");
