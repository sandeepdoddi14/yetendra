...
public class Verify_FieldSetting_Max_Leaves_per_Month extends TestBase {
    private static final Logger log = Logger.getLogger(Verify_FieldSetting_Max_Leaves_per_Month.class);
    ...
    public void Verify_Maximum_Leaves_Per_Month(Map<String, String> data) throws Exception {
            ...
            Assert.assertTrue( leavePage.setFromAndToDates(Integer.parseInt(data.get("maxLeavePerMonth"))),"Unable to set Leave Dates");
