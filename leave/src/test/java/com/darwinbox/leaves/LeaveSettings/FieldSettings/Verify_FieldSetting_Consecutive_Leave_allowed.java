...
public class Verify_FieldSetting_Consecutive_Leave_allowed extends TestBase {
    private static final Logger log = Logger.getLogger(Verify_FieldSetting_Consecutive_Leave_allowed.class);
    ...
    public void Verify_Min_Consecutive_allowed_Single_Application(Map<String, String> data) throws Exception {
        ...
        Assert.assertTrue(leavePage.setFromAndToDates(Integer.parseInt(data.get("ConsecutiveDays"))), "Unable to set Leave Dates");
