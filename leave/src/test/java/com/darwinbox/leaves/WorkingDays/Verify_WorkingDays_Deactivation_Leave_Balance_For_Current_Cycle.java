...
public class Verify_WorkingDays_Deactivation_Leave_Balance_For_Current_Cycle extends TestBase{
...
private static final Logger log = Logger.getLogger(Verify_WorkingDays_Deactivation_Leave_Balance_For_Current_Cycle.class);
...
public void Verify_Deactivation_Leave_Balance_of_an_employee_for_all_scenarios_without_creating_Leaves(Map<String,String> data) throws Exception {
		...
		String[] deactivationDates = {LocalDate.now().toString()};
