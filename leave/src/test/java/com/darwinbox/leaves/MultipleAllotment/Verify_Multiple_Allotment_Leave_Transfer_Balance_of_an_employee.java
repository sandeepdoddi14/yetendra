...
public class Verify_Multiple_Allotment_Leave_Transfer_Balance_of_an_employee extends TestBase {
    ...
    private static final Logger log = Logger.getLogger(Verify_Multiple_Allotment_Leave_Transfer_Balance_of_an_employee.class);
