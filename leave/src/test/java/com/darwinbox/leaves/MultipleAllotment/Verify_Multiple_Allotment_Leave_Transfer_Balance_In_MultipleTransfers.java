...
public class Verify_Multiple_Allotment_Leave_Transfer_Balance_In_MultipleTransfers extends TestBase {
    ...
    private static final Logger log = Logger.getLogger(Verify_Multiple_Allotment_Leave_Transfer_Balance_In_MultipleTransfers.class);
    ...
    public void Verify_Multiple_Allotment_Leave_Transfer_Balance_In_MultipleTransfers(Map<String, String> data) throws Exception {
...
//		Assert.assertTrue(leavesAction.verifyMultipleAllotmentLeaveTransferBalanceForCurrentCycle(), "Leave Balance for whole leave cycle calculated successfully") ;
        Assert.assertTrue(leavesAction.verifyMultipleAllotmentLeaveTransferBalanceForMultipleTransfers(), "Leave Balance for whole leave cycle calculated successfully");
