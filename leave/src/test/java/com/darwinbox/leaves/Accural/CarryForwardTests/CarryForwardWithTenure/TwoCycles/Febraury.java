package com.darwinbox.leaves.Accural.CarryForwardTests.CarryForwardWithTenure.TwoCycles;
...
public class Febraury extends LeaveAccuralBase {
    ...
    public void verifyCFWithTenure(Map<String, String> testData) {
        ...
        double expectedCarryForwardBalance=calculateLeaveBalance(employee.getDoj(),LocalDate.parse(serverChangedDate).minusDays(1).toString());
        ...
        expectedCarryForwardBalance = expectedCarryForwardBalance + untillFirstAniversery +afterFirstAnniverseryBalance;
        ...
        expectedCarryForwardBalance = expectedCarryForwardBalance + untillSecondAnniverseryBalance +afterSecondAnniverseryBalance;
