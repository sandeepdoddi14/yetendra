...
public class probation extends LeaveAccuralBase {
    ...
    public void verifyCarryForwardBalance(Map<String, String> testData) {
        ...
        String probationID="5afd2d4dd351c";
        ...
        try {
            employee = (new EmployeeServices().generateAnEmployee("no", "Working Days (DO NOT TOUCH)", leaveCycleEndDate.toString(), probationID));
        } catch (Exception e) {
            try {
                employee = (new EmployeeServices().generateAnEmployee("no", "Working Days (DO NOT TOUCH)", leaveCycleEndDate.toString(), probationID));
            } catch (Exception e1) {
