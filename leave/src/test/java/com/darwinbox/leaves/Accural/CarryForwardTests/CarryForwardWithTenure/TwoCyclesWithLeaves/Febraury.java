package com.darwinbox.leaves.Accural.CarryForwardTests.CarryForwardWithTenure.TwoCyclesWithLeaves;
...
public class Febraury extends LeaveAccuralBase {
    ...
    public void verifyCFWithTenure(Map<String, String> testData) {
        ...
        leaveCycleStartDate=LocalDate.parse("2018-02-01");
        leaveCycleEndDate=LocalDate.parse("2019-01-31");
        ...
        leaveResponse=applyLeave(employee,carryForwardBalance,leavePage.workingDays);
        ...
        leavePage.setFromAndToDatesWithoutProperty(noOfLeaves, leaveCycleStartDate);
        leaveResponse=applyLeave(employee,carryForwardBalance,leavePage.workingDays);
        if(leaveResponse.contains("failure"))
        {
         throw new Error("Error in applying Leave --> "+leaveResponse);
        }
        Reporter("No of Leaves applied -->" +noOfLeaves+";From Date -->"+leavePage.workingDays[0]+"     ;To Date is  --> "+ leavePage.workingDays[leavePage.workingDays.length-1],"Info");
        ...
        leavePage.setFromAndToDatesWithoutProperty(noOfLeaves, firstAnniverseryDate.plusDays(1));
