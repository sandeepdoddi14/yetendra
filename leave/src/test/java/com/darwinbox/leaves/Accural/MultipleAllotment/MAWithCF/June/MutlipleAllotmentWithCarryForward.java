package com.darwinbox.leaves.Accural.MultipleAllotment.MAWithCF.June;
...
public class MutlipleAllotmentWithCarryForward extends LeaveAccuralBase {
    ...
    public void verifyMultipleAllotmentBalance(Map<String, String> testData) {
        ...
        LocalDate firstLeaveCycleStartDate=LocalDate.parse("2019-05-01");
        LocalDate firstLeaveCyclceEndDate=LocalDate.parse("2020-04-31");
