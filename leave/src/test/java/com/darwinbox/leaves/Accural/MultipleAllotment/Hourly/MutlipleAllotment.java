package com.darwinbox.leaves.Accural.MultipleAllotment.Hourly;
...
public class MutlipleAllotment extends LeaveAccuralBase {
    ...
    public void verifyMultipleAllotmentBalance(Map<String, String> testData) {
        ...
        if(beforeFirstTransfer==actualBeforeFirstTransfer){
            Reporter("Pass","Pass");
        }
        else{
            Reporter("Fail","fail");
       ...
       if(afterFirstTransferBalance==actualAfterFirstTransfer){
           Reporter("Pass","Pass");
       }
       else{
           Reporter("Fail","Fail");
