...
public class Service extends TestBase {
    ...
    /*
    doPost Method
    gets based on url,header,request body
     */
...
//        TODO: need to check response when no designations available
   ...
   */
    ...
    public HashMap<String, HashMap<String, String>> getAllWeeklyOffs() {
        String url = data.get("@@url") + UtilityHelper.getProperty("ServiceUrls", "getAllWeeklyoffs");
