...
public class TestCreateAnExpenseAddingItemLinewiseAsEmployee extends TestBase {
    LoginPage loginPage;
    Expenses expenses;
    ...
    public void testCreateExpenseLinewise(Map<String, String> testData) throws Exception {
