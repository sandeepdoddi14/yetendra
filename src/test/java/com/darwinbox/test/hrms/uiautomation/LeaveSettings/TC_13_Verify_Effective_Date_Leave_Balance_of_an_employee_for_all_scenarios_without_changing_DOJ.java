...
public class TC_13_Verify_Effective_Date_Leave_Balance_of_an_employee_for_all_scenarios_without_changing_DOJ extends TestBase {
	...
	private static final Logger log = Logger.getLogger(TC_13_Verify_Effective_Date_Leave_Balance_of_an_employee_for_all_scenarios_without_changing_DOJ.class);
	...
	try {	
		...
		Reporter("Exception in TC_13_Verify_Effective_Date_Leave_Balance_of_an_employee_for_all_scenarios_without_changing_DOJ", "Fatal");
	}
	}
