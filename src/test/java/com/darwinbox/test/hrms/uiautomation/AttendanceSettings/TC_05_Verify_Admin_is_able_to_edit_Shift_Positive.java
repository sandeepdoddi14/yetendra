...
public class TC_05_Verify_Admin_is_able_to_edit_Shift_Positive extends TestBase {
	...
	private static final Logger log = Logger
			.getLogger(TC_05_Verify_Admin_is_able_to_edit_Shift_Positive.class);

	@BeforeClass
	public void setup() throws Exception {
		ExcelReader.setFilenameAndSheetName("Attendance_Settings_TestData.xlsx", "TC_05");
	}
	...
	public void Verify_Admin_is_able_to_edit_Shift_Positive(String input,String output) throws Exception {
		...
		Assert.assertTrue(attShiftSettings.clickShifts(),"Click on Shifts link");
			...
			Assert.assertTrue(attShiftSettings.editShiftDetails(),"Shift details edited successfully");	
			//Assert.assertTrue(attShiftSettings.searchShiftName(),"Search for Shift Name created");
