...
public class LeaveAdmin extends Services {
    ...
    public String ApplyLeave(String userId, String fromDate, String toDate, String leaveId) {
        ...
        return new Services().doPost(applyLeaveUrl, headers, mapToFormData(body));
    }
   ...
   */
    public String ApplyLeaveHourly(String userId, String fromDate, String toDate, String leaveId,int noOfHours) {
        ...
        Map<String, String> headers = new HashMap<>();
        headers.put("X-Requested-With", "XMLHttpRequest");
        return doPost(applyLeaveUrl, headers, mapToFormData(body));
    }
    ...
    public Map<String, String> GetLeavesByOnBehalf(String userMongoId) {
        ...
        String leaves = doPost(getLeavesByOnBehalf, headers, mapToFormData(body));
    ...
    public void revokeLeave(String leaveType, String leaveDate) {
        ...
        String response = doPost(leaveActionUrl, headers, mapToFormData(body));
    ...
    */
    ...
    public String getLeaveIdForRevoke(String MessageId) {
        ...
        Map<String, String> headers = new HashMap<>();
        headers.put("X-Requested-With", "XMLHttpRequest");
        String response = doPost(url, headers, mapToFormData(request));
