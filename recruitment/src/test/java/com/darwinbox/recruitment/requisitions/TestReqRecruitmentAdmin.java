...
public class TestReqRecruitmentAdmin extends RequisitionTestBase {
    ...
    public void testRequisition(Map<String, String> testData) throws Exception {
        ...
        if (reqID != null) {
            ...
            Reporter("Recruitment Admin raised Requisition for same Dept. As Expected", "PASS");
        } else
        ...
        if (afterRequisitions == (beforeRequisitions + 1))
            Reporter("Recruitment Admin can raise requisition for other Dept., as Expected", "PASS");
        else
            Reporter("Recruitment Admin Cannot raise for other Dept,NOT As Expected", "FAIL");
